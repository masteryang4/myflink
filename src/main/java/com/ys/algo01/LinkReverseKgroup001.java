...
public class LinkReverseKgroup001 {
    ...
    private static LinkofMine reverse_kgroup(LinkofMine head, int k) {
        if (head == null) {
            return null;
        }
        LinkofMine a = head;
        ...
        LinkofMine newHead = reverse_ab(a, b);
        head.next = reverse_kgroup(b, k);
        return newHead;
    }
